                ...
                <div>
                  <div class="row">
                    <div class="col-6">
                      ...
                      <p><strong class="item-price">S/{{$product -> pricing}}</strong></p>
                    </div>
                    <div class="col-6">
                      <a href="{{ route('post', $product->slug) }}"><button type="button" class="btn btn-success btn-sm">Más Info <i class="lni lni-arrow-right"></i></button></a>
                    </div>
                  </div>
                </div>
              </div>
